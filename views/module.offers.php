...
$resoffr = $socialshare = $expired = $enquiry = '';
...
if (defined('OFFERS_PAGE') and isset($_REQUEST['slug'])) {
    ...
    if (!empty($recRow)) {
        ...
        $offbredd .= '
            <section class="breadcrumb-area overlay-dark-2 bg-2" style="background-image:url(' . $imglink . '); background-repeat: no-repeat; ">    
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
    ...
    $offbredd .= '
        <section class="breadcrumb-area overlay-dark-2 bg-2" style="background-image:url(' . BASE_URL . 'images/fac.jpg); background-repeat: no-repeat; ">        
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="breadcrumb-text article text-center">
