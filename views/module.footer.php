...
foreach ($telno as $tel) {
    ...
    $tellinked .= ' | <a href="tel:+977-' . $tel1 . '" target="_blank" rel="noopener" >' . $tel1 . '</a>';
    if (end($telno) != $tel) {
        $tellinked .= '/';
    }
}
...
$phonelinked .= '<a href="tel:+977-' . $lastElement . '" target="_blank" rel="noopener" >' . $lastElement . '</a>/';
foreach ($phoneno as $phone) {
    $phonelinked .= '<a href="tel:+977-' . $phone . '" target="_blank" rel="noopener" >' . $phone . '</a>';
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="fs-6 fw-normal">
                        ...
                        <p class="mt-3">
                        Website by <a href="https://longtail.info/" target="_blank" rel="noopener"  class="text-dark-blue">Longtail e-Media</a>
                        </p>
                    </div>
                </div>
            </div>
...
if (!empty($siteRegulars->whatsapp_a)) {
    $whatsapp = '
        <div class="messenger">
            <a href="' . $siteRegulars->whatsapp_a . '" target="_blank" rel="noopener" ><img src="' . BASE_URL . 'template/web/images/whatsapp.png"></a>
        </div>
    ';
}
