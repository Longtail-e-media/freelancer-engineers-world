        ...
        <div class="form-row">
            <div class="" id="previewUserimage<?php echo $deleteid; ?>">
                <div class="infobox info-bg col-md-3">
                    <img src="<?php echo IMAGE_PATH . 'freelancer/profile/thumbnails/' . $val; ?>" style="width:100%"/>
...
if (isset($_SESSION['imageNameArr'])) {
    if (count($_SESSION['imageNameArr']) > 0) {
        foreach ($_SESSION['imageNameArr'] as $key => $val) {
            @unlink(IMAGE_PATH . 'freelancer/profile/thumbnails/' . $val);
            @unlink(IMAGE_PATH . 'freelancer/profile/' . $val);
        }
