<script language="javascript">
    ...
    function getLocation() {
        return '<?php echo BASE_URL;?>includes/controllers/ajax.freelanceruser.php';
    }
    ...
    function AddNewUsers() {
        window.location.href = "<?php echo ADMIN_URL?>freelanceruser/addEdit";
    }

    /***************************************** View Users Lists *******************************************/
    function viewuserslist() {
        window.location.href = "<?php echo ADMIN_URL?>freelanceruser/list";
    }

    /***************************************** Edit User login Info *******************************************/
    function editRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>freelanceruser/addEdit/" + Re;
    }
