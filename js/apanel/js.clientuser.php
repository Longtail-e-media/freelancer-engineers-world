<script language="javascript">
    ...
    function getLocation() {
        return '<?php echo BASE_URL;?>includes/controllers/ajax.clientuser.php';
    }
    ...
    function AddNewUsers() {
        window.location.href = "<?php echo ADMIN_URL?>clientuser/addEdit";
    }

    /***************************************** View Users Lists *******************************************/
    function viewuserslist() {
        window.location.href = "<?php echo ADMIN_URL?>clientuser/list";
    }

    /***************************************** Edit User login Info *******************************************/
    function editRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>clientuser/addEdit/" + Re;
    }

    function permission(Re) {
        window.location.href = "<?php echo ADMIN_URL?>clientuser/permission/" + Re;
    }
