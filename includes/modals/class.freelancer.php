...
class freelancer extends DatabaseObject
{

    protected static $table_name = "tbl_freelancer";
    ...
    public $mobile_no;
    public $phone_no;
    public $education_lvl;
    public $current_address;
    public $permanent_address;
    public $pan_no;
    public $upload_certificate;
    public $upload_cv;
    public $portfolio_website;
    ...
    {
        global $db;
        $sql = "SELECT id FROM " . self::$table_name . " WHERE user_id={$id} LIMIT 1";
        $result = $db->query($sql);
        $return = $db->fetch_array($result);
