...
if (isset($_GET['page']) && $_GET['page'] == "freelanceruser" && isset($_GET['mode']) && $_GET['mode'] == "list"):
    ?>
    <h3>
    ...
    <div class="example-box">
        <div class="example-code">
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                $records = User::find_by_sql("SELECT * FROM " . $moduleTablename . " WHERE group_id=4 AND id<>2 ORDER BY sortorder ASC ");
    ...
    <div class="example-box">
        <div class="example-code">
            <form action="" class="col-md-10 center-margin" id="adminusersetting_frm">
                ...
                <button type="submit" name="submit" id="btn-submit" title="Save"
